...
import io.github.gabriellisartori.class11_above.config.EmailConfig;
import io.github.gabriellisartori.class11_above.data.dto.request.EmailRequestDTO;
import io.github.gabriellisartori.class11_above.mail.EmailSender;
...
public class EmailService {
    ...
    public void sendEmailWithAttachment(String emailRequestJson, MultipartFile attachment) {
        ...
        try {
            ...
            throw new RuntimeException("Error parssing e-mail request", e);
        } catch (IOException e) {
